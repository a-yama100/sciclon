        ...
        <div>
            ...
            <label>
                ...
                <select value={selectedSubject} onChange={handleChangeSubject}>
                    ...
                    <option value="aws_associate_solutions_architect_glossary">GCP_Associate_Cloud_Engineer</option>
                    <option value="aws_associate_solutions_architect_glossary">GCP_Professional_data_engineer</option>
                    {/* 他の科目もここに追加... */}
                </select>
            </label>
